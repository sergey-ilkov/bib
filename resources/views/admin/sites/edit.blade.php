...
<div class="content">
    ...
    <div class="content-box">
        ...
        <div class="content-box-top">
            ...
            <x-admin.link href="{{ route('admin.sites.index') }}" class="admin-link">
        ...
        <div class="content__item">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('admin.sites.update', $site) }}" method="PUT" class="card-form">
                        ...
                        <div class="card-body__group">
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="name" value="{{ $site->name }}" />
                            </x-admin.form-item>
                            <x-admin.form-item>
                                <x-admin.label> {{ __('Domen ( example.com )')}} </x-admin.label>
                                <x-admin.input name="domen" value="{{ $site->domen}}" />
                            </x-admin.form-item>
                            <x-admin.form-item>
                                <x-admin.label> {{ __('URL upload file ( https://example.com )')}} </x-admin.label>
                                <x-admin.input name="settings[file_upload_url]" value="{{ $site->settings['file_upload_url'] }}" />
                            </x-admin.form-item>
                        ...
                        <div class="card-body-box">
                            ...
                            <div class="group-item">
                                ...
                                <div class="card-body__group card-body__group-switch">
                                    <x-admin.form-item>
                                        <x-admin.checkbox name="settings[device_script]" :checked="$site->settings['device_script']" id="device_script" role="switch" />
